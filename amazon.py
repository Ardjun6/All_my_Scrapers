...
def get_amazon_product_details(url):
    ...
    try:
        ...
        price_span = soup.find('span', {'class': 'a-price aok-align-center'})
        if price_span:
...
product_url = 'https://www.amazon.com/HP-Students-Business-Quad-Core-Storage/dp/B0B2D77YB8/ref=sr_1_3?sr=8-3'
